...
export function buildReportPlan(featureNames: string[]): ReportPlanSection[] {
  ...
  return [
    ...
    },
    {
      ...
      subitems: ["기능별 만족도", "문항별 정성 분석"],
    },
    {
      numeral: "IV",
      title: "핵심구매요소",
      source: "순위 응답 기반 상대중요도 산출 + 응답 분포",
      subitems: ["기능별 상대중요도", "핵심 요인 분포", "해석"],
    },
    {
      numeral: "V",
      title: "4대가치 만족도",
      source: "기능적·심미적·경제적·사회공공적 가치 통계 + 각 가치 주관식 응답 정성 분석",
      subitems: ["가치 영역별 만족도", "문항별 정성 분석"],
    },
    {
      numeral: "VI",
      title: "사용자 경험 품질 평가",
    ...
    },
    {
      ...
      subitems: ["연령대별 기능 만족도", "성별 기능 만족도"],
    },
    {
      numeral: "VIII",
      title: "NPS 종합만족도 및 개선아이디어",
      source: "NPS 계산 + 전반적 만족도 통계 + 관련 주관식 정성 분석 + 개선 아이디어 분류",
      subitems: ["종합만족도", "NPS", "개선 아이디어"],
    },
    {
      numeral: "IX",
      title: "종합결과 및 제언",
      source: "결과요약 자동 생성 + 개발우선순위/기능개선 제언(검수 승인 필요) + 종합전략제언(담당자 입력)",
      subitems: ["사용성테스트 결과 요약", "개발 우선순위 제언", "기능별 고객 제언 종합", "종합전략제언"],
    },
  ];
}
